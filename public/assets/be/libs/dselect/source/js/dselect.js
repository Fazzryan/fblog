...
function dselect(el, option = {}) {
  ...
  function createDom() {
    ...
    <div class="dropdown ${classElement} ${additionalClass}">
      <button style="text-align:left;" class="${classToggler} ${!el.multiple && clearable ? classTogglerClearable : ''}" data-dselect-text="${!el.multiple && selectedText(el.options)}" type="button" data-bs-toggle="dropdown" aria-expanded="false"${autoclose}>
